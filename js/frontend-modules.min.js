...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[354], {
    ...
    8738: (e, t, n) => {
        ...
        class ContactButtonsHandler extends r.default {
            ...
            removeAnimationClasses() {
                const {reverse: e, entranceAnimation: t, exitAnimation: n, animated: i, visible: r} = this.getSettings("constants")
                  , s = this.elements.content.classList.contains(e)
                  , o = this.getResponsiveSetting(t)
                  , a = this.getResponsiveSetting(n);
                s ? (this.elements.content.classList.remove(i),
                this.elements.content.classList.remove(e),
                this.elements.content.classList.remove(a),
                this.elements.content.classList.remove(r)) : (this.elements.content.classList.remove(i),
            ...
            chatBoxEntranceAnimation() {
                ...
                i !== r && (this.elements.content.classList.add(t),
                this.elements.content.classList.add(r),
                this.elements.contentWrapper.classList.remove(n))
            }
            chatBoxExitAnimation() {
                const {reverse: e, exitAnimation: t, animated: n, animatedWrapper: i, none: r} = this.getSettings("constants")
                  , s = this.getResponsiveSetting(t);
                r !== s && (this.elements.content.classList.add(n),
                this.elements.content.classList.add(e),
                this.elements.content.classList.add(s),
                this.elements.contentWrapper.classList.add(i))
            }
            openChatBox() {
                const {hasAnimations: e, visible: t, hidden: n} = this.getSettings("constants");
                this.elements.main.classList.contains(e) ? this.chatBoxEntranceAnimation() : this.elements.content.classList.add(t),
                this.elements.contentWrapper.classList.remove(n)
            }
            closeChatBox() {
                const {hasAnimations: e, visible: t, hidden: n} = this.getSettings("constants");
                this.elements.main.classList.contains(e) ? this.chatBoxExitAnimation() : this.elements.content.classList.remove(t),
            ...
            initChatButtonEntranceAnimation() {
                const {none: e, chatButtonAnimation: t, animated: n} = this.getSettings("constants")
                  , i = this.getResponsiveSetting(t);
                e !== i && (this.elements.chatButton.classList.add(n),
    ...
    1695: (e, t, n) => {
        ...
        var i = n(2086)
          ...
          , c = n(7189);
        e.exports = function(e, t) {
            var n, u, d, h, g, m = e.target, p = e.global, f = e.stat;
    ...
    3278: (e, t, n) => {
        "use strict";
        var i, r, s, o = n(640), a = n(2086), l = n(8759), c = n(2585), u = n(9606), d = n(4489), h = n(8944), g = n(7153), m = "Object already initialized", p = a.TypeError, f = a.WeakMap;
        if (o || d.state) {
    ...
    3712: (e, t, n) => {
        ...
        var i = n(8240)
          ...
          , S = e.exports = function(e, t, n) {
            "Symbol(" === p(g(t), 0, 7) && (t = "[" + f(g(t), /^Symbol\(([^)]*)\)/, "$1") + "]"),
            n && n.getter && (t = "get " + t),
            n && n.setter && (t = "set " + t),
            (!o(e, "name") || l && e.name !== t) && (a ? m(e, "name", {
                value: t,
                configurable: !0
            }) : e.name = t),
            b && n && o(n, "arity") && e.length !== n.arity && m(e, "length", {
                value: n.arity
            });
            try {
